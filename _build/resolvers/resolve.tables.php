...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('modiiko_core_path', null,
                    $modx->getOption('core_path') . 'components/modiiko/') . 'model/';
            $modx->addPackage('modiiko', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/modiiko/model/schema/modiiko.mysql.schema.xml';
        ...
        case xPDOTransport::ACTION_UNINSTALL:
            ...
            /*
            $modelPath = $modx->getOption('modiiko_core_path', null, $modx->getOption('core_path') . 'components/modiiko/') . 'model/';
            $modx->addPackage('modiiko', $modelPath);
